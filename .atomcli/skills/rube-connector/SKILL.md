...
1.  **Install:** Check for `composio` or `rube` package.
    *   Typically: `bunx composio login` and `bunx composio apps add [app_name]`
...
3.  **Fallback:** If the tool is missing, guide the user to install the integration: "I need access to GitHub. Please run `bunx composio add github` to enable this integration."
