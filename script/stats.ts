...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/aToom13/AtomCLI/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for aToom13/AtomCLI...\n")
...
console.log("Fetching npm all-time downloads for atomcli...\n")
const npmDownloads = await fetchNpmDownloads("atomcli")
