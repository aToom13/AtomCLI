...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/atomcli")).toEqual({ owner: "sst", repo: "atomcli" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/atomcli.git")).toEqual({ owner: "sst", repo: "atomcli" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/atomcli")).toEqual({ owner: "sst", repo: "atomcli" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/atomcli.git")).toEqual({ owner: "sst", repo: "atomcli" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/atomcli")).toEqual({ owner: "sst", repo: "atomcli" })
})
