...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ATOMCLI_CALLER", () => {
    process.env["ATOMCLI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ATOMCLI_CALLER", () => {
    process.env["ATOMCLI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ATOMCLI_CALLER", () => {
    process.env["ATOMCLI_CALLER"] = "unknown"
