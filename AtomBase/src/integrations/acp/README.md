...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for atomcli.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal atomcli sessions
...
- **Terminal Integration**: Full terminal support via atomcli's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | atomcli acp
```
...
ACP sessions map cleanly to atomcli's internal session model:
