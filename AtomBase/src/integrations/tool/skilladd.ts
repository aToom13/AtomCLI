...
const parameters = z.object({
  ...
  name: z
    .string()
    .optional()
    .describe("Custom name for the skill. If not provided, uses the name from SKILL.md frontmatter."),
})
...
export const SkillAddTool = Tool.define("skilladd", {
  ...
  async execute(params, ctx) {
    ...
    // Refresh skill cache so the new skill is immediately available
    await Skill.reload()
