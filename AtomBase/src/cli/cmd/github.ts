...
const AGENT_USERNAME = "atomcli-agent[bot]"
const AGENT_REACTION = "eyes"
const WORKFLOW_FILE = ".github/workflows/atomcli.yml"
      ...
      async fn() {
        {
          ...
          function printNextSteps() {
            ...
            prompts.outro(
              [
                ...
                "",
                "   Learn more about the GitHub agent - https://atomcli.ai/docs/github/#usage-examples",
              ].join("\n"),
            )
          }
          ...
          async function installGitHubApp() {
            ...
            // Open browser
            const url = "https://github.com/apps/atomcli-agent"
            const command =
            ...
            async function getInstallation() {
              return await fetch(
                `https://api.atomcli.ai/get_github_app_installation?owner=${app.owner}&repo=${app.repo}`,
              )
                .then((res) => res.json())
...
jobs:
  atomcli:
    if: |
      ...
      contains(github.event.comment.body, ' /atomcli') ||
      startsWith(github.event.comment.body, '/atomcli')
    ...
    steps:
      ...
      - name: Run atomcli
        uses: anomalyco/atomcli/github@latest${envStr}
        with:
