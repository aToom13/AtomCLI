...
import type { PermissionRequest } from "@atomcli/sdk/v2"
import { useSDK } from "../../context/sdk"
import { SplitBorder } from "../../component/border"
import { useSync } from "../../context/sync"
import { useTextareaKeybindings } from "../../component/textarea-keybindings"
import path from "path"
import { LANGUAGE_EXTENSIONS } from "@/integrations/lsp/language"
          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until AtomCLI is restarted."} />
              </Match>
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until AtomCLI is restarted</text>
                  <box>
        ...
        <Prompt
          ...
          body={
            <Switch>
              ...
              <Match when={props.request.permission === "find"}>
                <TextBody icon="✱" title={`Find "` + (input().pattern ?? "") + `"`} />
              </Match>
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          <text fg={theme.textMuted}>Tell AtomCLI what to do differently</text>
        </box>
      </box>
      <box
        flexDirection="row"
