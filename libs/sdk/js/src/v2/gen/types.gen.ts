...
/**
 * Server configuration for atomcli serve and web commands
 */
...
export type McpResourceListData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type McpResourceListResponses = {
  /**
   * List of resources
   */
  200: {
