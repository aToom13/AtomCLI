import type { ProviderAuthAuthorization } from "@atomcli/sdk/v2/client"
import { Button } from "@atomcli/ui/button"
import { useDialog } from "@atomcli/ui/context/dialog"
import { Dialog } from "@atomcli/ui/dialog"
...
import { List, type ListRef } from "@atomcli/ui/list"
import { ProviderIcon } from "@atomcli/ui/provider-icon"
import { Spinner } from "@atomcli/ui/spinner"
import { TextField } from "@atomcli/ui/text-field"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "atomcli"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            AtomCLI Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                          ...
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://atomcli.ai/zen" tabIndex={-1}>
                              atomcli.ai/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in AtomCLI.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in AtomCLI.
                        </div>
